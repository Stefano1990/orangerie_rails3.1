...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activeresource>, ["= 3.1.0.rc4"])
      s.add_runtime_dependency(%q<actionmailer>, ["= 3.1.0.rc4"])
      ...
      s.add_dependency(%q<activeresource>, ["= 3.1.0.rc4"])
      s.add_dependency(%q<actionmailer>, ["= 3.1.0.rc4"])
